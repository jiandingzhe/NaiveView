...
ScreenPoint screen_rect_landscape[4] = {
    {-1.0f, -1.0f, 0.0, 1.0f}, {-1.0f, 1.0f, 0.0f, 0.0f}, {1.0f, -1.0f, 1.0f, 1.0f}, {1.0f, 1.0f, 1.0f, 0.0f}};

ScreenPoint screen_rect_portrait[4] = {
    {-1.0f, -1.0f, 1.0, 1.0f}, {-1.0f, 1.0f, 0.0f, 1.0f}, {1.0f, -1.0f, 1.0f, 0.0f}, {1.0f, 1.0f, 0.0f, 0.0f}};
